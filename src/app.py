...
app.layout = html.Div([
    ...
    html.Div([
        ...
        # Page content with loading spinner (scoped to page navigation only, so nested
        # callbacks elsewhere on the page - e.g. chat - don't trigger a full-page spinner)
        dcc.Loading(
            id='page-loading',
            type='default',
            color='#4caf50',
